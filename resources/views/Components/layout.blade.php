        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/jobs" :active="request()->is('jobs')">Meslekler</x-nav-link>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button"
                                        ...
                                        <img class="size-8 rounded-full" src="{{ asset('images/robot.jpeg') }}" alt="">
                                    </button>
                                </div>
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="/"
                        class="{{ request()->is('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white  block rounded-md'}}  bg-gray-900 px-3 py-2 text-base font-medium"
                    ...
                    <a href="#"
                        class="{{ request()->is('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}}  block rounded-md px-3 py-2 text-base font-medium ">Calendar</a>
                    <a href="#"
                        class="{{ request()->is('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'}}  block rounded-md px-3 py-2 text-base font-medium">Reports</a>
                </div>
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        <div class="shrink-0">
                            <img class="size-10 rounded-full" src="{{ asset('images/robot.jpeg') }}" alt="">
                        </div>
                        <div class="ml-3">
